...
def create_graph(mode, batch_size, encoder_nchars, max_target_length, decoder_nchars):
    ...
    if "TRAIN" == mode:
        ...
        adam_gradients, _ = tf.clip_by_global_norm(adam_gradients, 5.0)
        ...
        return encoder_char_ids_ph, encoder_lengths_ph, decoder_char_ids_ph, decoder_lengths, adam_optimize, train_prediction, outputs
